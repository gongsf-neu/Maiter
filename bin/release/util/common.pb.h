...
inline void Record::clear_value1() {
  if (value1_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    value1_->clear();
  }
  clear_has_value1();
}
...
inline ::std::string* Record::release_value1() {
  ...
  if (value1_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    ...
    value1_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    return temp;
  }
}
...
inline void Record::clear_value2() {
  if (value2_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    value2_->clear();
  }
  clear_has_value2();
}
...
inline ::std::string* Record::release_value2() {
  ...
  if (value2_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    ...
    value2_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    return temp;
  }
}
...
inline void Record::clear_value3() {
  if (value3_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    value3_->clear();
  }
  clear_has_value3();
}
...
inline ::std::string* Record::release_value3() {
  ...
  if (value3_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    ...
    value3_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    return temp;
  }
}
...
inline double TermcheckDelta::delta() const {
  // @@protoc_insertion_point(field_get:dsm.TermcheckDelta.delta)
  return delta_;
}
inline void TermcheckDelta::set_delta(double value) {
  set_has_delta();
  delta_ = value;
  // @@protoc_insertion_point(field_set:dsm.TermcheckDelta.delta)
}
